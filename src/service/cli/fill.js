...
const {ExitCode, FilePath, MAX_COMMENTS, DEFAULT_COUNT, MAX_COUNT} = require(`../../consts`);
const {
  getRandomInt,
  shuffle,
} = require(`../../utils`);
...
const generateArticles = (count, titles, categoryCount, userCount, sentences, comments) => (
  Array(count).fill({}).map((_, index) => ({
    ...
    announcement: shuffle(sentences).slice(1, 5).join(` `),
    photo: 'picture.jpg',
  ...
  async run(args) {
    ...
    const countArticle = Number.parseInt(count, 10) || DEFAULT_COUNT;
      ...
      // try {
        ...
        const content = `
          INSERT INTO users(email, password_hash, first_name, last_name, avatar, role) VALUES ${userValues};
          INSERT INTO categories(name) VALUES ${categoryValues};

          ALTER TABLE articles DISABLE TRIGGER ALL;
          INSERT INTO articles(title, announcement, text, photo, user_id) VALUES ${articleValues};
          ALTER TABLE articles ENABLE TRIGGER ALL;

          ALTER TABLE article_categories DISABLE TRIGGER ALL;
          INSERT INTO article_categories(article_id, category_id) VALUES ${articleCategoryValues};
          ALTER TABLE article_categories ENABLE TRIGGER ALL;

          ALTER TABLE article_comments DISABLE TRIGGER ALL;
          INSERT INTO article_comments(article_id, comment_id) VALUES ${articleCommentsValues};
          ALTER TABLE article_comments ENABLE TRIGGER ALL;

          ALTER TABLE user_articles DISABLE TRIGGER ALL;
          INSERT INTO article_comments(user_id, article_id) VALUES ${userArticlesValues};
          ALTER TABLE user_articles ENABLE TRIGGER ALL;

          ALTER TABLE user_comments DISABLE TRIGGER ALL;
          INSERT INTO user_comments(user_id, comment_id) VALUES ${userCommentsValues};
